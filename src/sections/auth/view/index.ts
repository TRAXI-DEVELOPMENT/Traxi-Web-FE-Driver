...
export { default as RegisterIllustrationView } from './RegisterIllustrationView';
//
export { default as ResetPasswordView } from './ResetPasswordView';
export { default as VerifyCodeView } from './VerifyCodeView';
export { default as DemoLoginBackgroundView } from '../../../pages/demo/section/auth/views/LoginView'